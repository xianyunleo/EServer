...
#define CONFIGURE_ARGS " '--prefix=/Applications/EasySrv/Library/libpq' '--disable-debug'"
...
#define PG_VERSION_STR "PostgreSQL 14.5 on x86_64-apple-darwin20.6.0, compiled by Apple clang version 12.0.5 (clang-1205.0.22.11), 64-bit"
