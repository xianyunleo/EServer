...
#define CONFIGURE_ARGS " '--prefix=/Applications/EServer/Library/libpq' '--disable-debug'"
...
#define PG_VERSION_STR "PostgreSQL 15.4 on x86_64-apple-darwin22.2.0, compiled by Apple clang version 14.0.3 (clang-1403.0.22.14.1), 64-bit"
