export default {
    ...
    Refresh: 'Actualiser',
    RefreshingService: 'Actualisation du service en cours',
    Language: 'Langue',
    Local: 'Local',
    Confirm: 'Confirmer',
    Submit: 'Soumettre',
    ...
    websiteAutoRestartText: 'Après avoir enregistré le site Web, démarrez ou redémarrez automatiquement le services.',
    ...
    afterOpenAppStartService: "Démarrez le services après avoir ouvert l'application.",
    ...
    'Error starting service!': 'Erreur lors du démarrage du {0}!',
    'The service was not stopped successfully!': "Le {0} n'a pas été arrêté avec succès!",
    'Error stopping service!': "Une erreur s'est produite lors de l'arrêt du {0}!",
    Ready: 'Prêt',
    ...
    Timer: 'Minuterie',
    TimerServiceList: 'Liste de service temporisés',
    RestartIntervalText: 'Cycle horaire',
    ServiceAutoRestartText: 'Service de redémarrage planifié',
    Hours: 'Heures',
    Minutes: 'Minutes',
    Seconds: 'Secondes',
    Days: 'Jours',
