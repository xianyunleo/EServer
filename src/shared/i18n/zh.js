export default {
    ...
    websiteAutoRestartText: '保存站点后，自动重启服务',
    ...
    afterOpenAppStartService: '打开软件后，启动服务',
    pleaseChoose: '请选择',
    ...
    'Error starting service!': '启动{0}出错！',
    'The service was not stopped successfully!': '{0}没有成功停止！',
    'Error stopping service!': '停止{0}出错！',
    Ready: '正在开始',
    Downloading: '下载中',
    Unzipping: '解压中',
    Configuring: '配置中',
    ...
    Timer: '定时器',
    TimerServiceList: '服务列表',
    RestartIntervalText: '重启周期',
    ServiceAutoRestartText: '定时重启服务',
    Hours: '小时',
    Minutes: '分钟',
    Seconds: '秒',
    Days: '天',
